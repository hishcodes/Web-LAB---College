...
echo <<<END
<form action=sturecord.php method=POST>
...
$name=$_POST['t2'];
$marks=$_POST['t3'];
$sql="INSERT into studetails values('$USN','$name','$marks')";
...
from studetails"; $result=$pdo->query($sql); $cnt=0;
while(($row=$result->fetch()))
{
$student_data[$cnt][0]=$row['USN'];
$student_data[$cnt][1]=$row['name'];
$student_data[$cnt][2]=$row['marks'];
++$cnt;
}
